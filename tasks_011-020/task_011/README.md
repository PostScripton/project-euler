...
(the four marked numbers are `26`, `63`, `78`, `14`, with product `26 × 63 × 78 × 14 = 1788696`)

The grid is also provided as plain text in [`grid.txt`](./grid.txt), for the solutions to read.
